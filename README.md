...
Welcome to share your command tag [here](https://github.com/niehu2018/zotero-gpt-plus/discussions/3) using [Meet API](src/modules/Meet/api.ts).
...
- [x] 🏷️ [Command tags](https://github.com/niehu2018/zotero-gpt-plus#command-tags): **Click once** to accelerate your research.  
...
## How to use
- [x] Get `.xpi` file
  - [ ] [download latest](https://github.com/niehu2018/zotero-gpt-plus/releases/latest/download/zotero-gpt-plus.xpi) release `.xpi` file
  - [ ] or build this project [1] to generate a `.xpi` file
- [x] Install `.xpi` file in Zotero [2]
- [x] Open Zotero GPT Plus [3]
...
```bash
git clone https://github.com/niehu2018/zotero-gpt-plus.git
cd zotero-gpt-plus
npm install
npm run build
```
...
### [3] Open/Exit Zotero GPT Plus

|Action|Shortcut|
|--|--|
|Open|<img src="https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/f76b23ee-8c54-47da-823c-8c14faa88a87" width="20%">|
|Exit|`ESC`|
|Multi-line editing| `Shift` + `Enter`|

### [4] Set up the API key

![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/225c468a-acfc-43be-b5ac-cf6aaaa33e96)
...
|----|-------------|---------------------------|
|1   | Open Zotero GPT Plus | Refer to [3] Open/Exit Zotero GPT Plus |
|2   | Type `#Tag Name` and press `Enter` | ![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/52f776fc-5592-4c17-8c36-7769c537ef79) |
|3   | Input your prompt or code | ![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/6f6d9985-69e5-4d29-ba78-df31e30e9cd1) |
|4   | **R**un your tag | Press `Ctrl + R` |
|5   | **S**ave your tag | Press `Ctrl + S` |
|6   | Long press a command tag to access the editing interface | ![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/28235117-79ab-43c6-b175-079e609683f4) |
|7   | Modify the tag's color, position, or trigger; remember to save with `Ctrl + S` | ![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/5261878a-30ce-4ea5-b3be-9c6b9ef29f70) |
...
![How to run a command tag](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/fdfc369a-1e96-478c-a7c2-4a93d2d7a580)

![image](https://github.com/niehu2018/zotero-gpt-plus/assets/51939531/d7f857a4-9ed9-42af-8662-6336ce70a881)
